 ...
 * @author w
 */
public class Option_2_Frame extends javax.swing.JFrame {

    String[] keyForWriteOut;

    /**
     * Creates new form Option_2_Frame
     */
    public Option_2_Frame() {
        initComponents();
    }
    ...
    private void genButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_genButtonActionPerformed
        ...
        int amount = 0, length, type;
        length = this.lengthOption.getSelectedIndex() + 6;
        type = this.typeOption.getSelectedIndex() + 1;

        try {
            amount = Integer.parseInt(nKey.getText());
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Enter Wrong Format.\nTry Again", null, 0);
        }

        Random r = new Random(length, amount, type);
        String[] keyForPrintOut = new String[amount];
        keyForWriteOut = keyForPrintOut = r.compilePassForGUI();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Option_2_Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Option_2_Frame().setVisible(true);
            }
        });
    }
